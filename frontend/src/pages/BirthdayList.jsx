    ...
    <div className="p-4 lg:p-8 pb-20 lg:pb-8">
      ...
      {Object.keys(birthdaysByMonth).length === 0 ? (
        ...
        Object.keys(birthdaysByMonth)
          ...
          .map((month) => (
            <div key={month} className="card p-6 mb-6">
              <h2 className="text-xl font-semibold mb-4">
                {monthNames[month]} ({birthdaysByMonth[month].length})
              </h2>
              {birthdaysByMonth[month].map((birthday) => (
                ...
                >
                  <div>
                    ...
                    <p>
                      {formatDate(birthday.birthdate)} • Age{" "}
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      onClick={() => handleDeleteBirthday(birthday._id)}
